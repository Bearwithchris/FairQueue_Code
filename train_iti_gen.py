...
def parse_args():
    ...
    parser.add_argument('--ckpt-path', type=str, default='./ckpts/run1_full_010124/',
    ...
    parser.add_argument('--attr-list', type=str, default='High_Cheekbones',
                        help='input the attributes that you want to debias, separated by commas. Eg, Male,Eyeglasses,...')
...
if __name__ == '__main__':
    ...
    if torch.cuda.is_available():
        ...
        print ("CUDA is unavail")
    
    
        
    args = parse_args()
    args.device=torch.device("cuda") #Edited
